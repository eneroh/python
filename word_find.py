...
It is missing 2 features, displaying lines where the word appears and highlight functionality for word on line. 
Need to add when I gain more knowledge. Expect a text_findv2.py shortly. Think this may involve dict?
"""
